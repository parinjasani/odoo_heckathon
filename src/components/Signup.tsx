  ...
  return (
    ...
    className="flex items-center justify-center">
      <div className="bg-white h-11/12 w-7/12 rounded-sm p-8">
        ...
        <h1 className="text-center font-bold text-gray-500 mt-3">A Minimal Q&A Forum Platform</h1>
        ...
        <hr className="mt-3"/>
        <h1 className="text-sm text-center mt-3 text-zinc-600">About . Careers . Privacy . Terms . Contact . Languages . Your . Ad . Choices . Press© StackIt, Inc. 2024</h1>
      </div> 
